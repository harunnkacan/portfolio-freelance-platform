...
import { Package, User, CreditCard, Download, ExternalLink, Trash2, Save, Key } from 'lucide-react';
...
export function DashboardPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-24 min-h-screen cyber-grid">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <section className="glass-red p-8 border-red-500/20 bg-red-500/5 h-fit">
              ...
              <p className="text-sm text-muted-foreground uppercase font-bold mb-8 italic">
                Hesabınızı sildiğinizde tüm sipariş geçmişiniz, yorumlarınız ve dijital ürün erişimleriniz kalıcı olarak kaldırılacaktır.
              </p>
