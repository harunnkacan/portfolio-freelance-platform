    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="cyber-grid min-h-screen py-12 md:py-24">
          ...
          {pricingTiers.map((tier, idx) => (
            ...
            >
              ...
              <div className="mb-8">
                ...
                <span className="text-muted-foreground text-xs uppercase font-bold ml-2">'dan ba��layan</span>
              </div>
        ...
        <section className="glass-red p-12 md:p-20 text-center border-primary/30 relative overflow-hidden group">
           ...
           <h2 className="text-4xl md:text-6xl font-black tracking-tighter uppercase mb-6 relative z-10">ÖZEL BİR PROJENİZ Mİ VAR?</h2>
           ...
           <Button asChild size="lg" className="btn-cyber h-16 px-12 rounded-none relative z-10">
             <Link to="/contact" className="flex items-center gap-3">ÜCRETSİZ TEKL��F AL <ArrowRight size={20} /></Link>
           </Button>
        </section>
      </div>
    </div>
